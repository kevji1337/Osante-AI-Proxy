...
// Endpoint type, ProxyConfig, BackupConfig, UpdateConfig, TerminalConfig,
// WebDAVConfig, LocalBackupConfig, S3BackupConfig, and Config itself live in
// types.go. Keep this file for behavior (constants, validation, getters,
// setters, storage adapter).
...
func DefaultConfig() *Config {
	return &Config{
		...
		ModelsCacheRefreshEnabled: false,
		Endpoints: []Endpoint{
			{
