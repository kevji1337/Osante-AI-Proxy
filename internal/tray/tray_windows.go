...
var menuTexts = map[string]struct {
	...
	"zh-CN": {
		...
		ShowTip: "显示主窗口",
		Quit:    "退出程序",
		QuitTip: "退出 Osante Proxy",
		Tooltip: "Osante Proxy - API 端点轮换代理",
	},
	"en": {
		Show:    "Show Window",
		ShowTip: "Show the main window",
		Quit:    "Quit",
		QuitTip: "Quit Osante Proxy",
		Tooltip: "Osante Proxy - API Endpoint Rotation Proxy",
	},
}
